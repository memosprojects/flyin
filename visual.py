...
class VisualInterface(arcade.Window):
    ...
    uipath = Path("uilibrary/kenney_ui-pack-pixel-adventure/Tiles/Tilesheets/Large tiles/Thick outline/tilemap_packed.png")
    sheet = arcade.load_spritesheet("assets/ui_tiles.png")
    textures = arcade.load_spritesheet("assets/ui_tiles.png", sprite_width=16, sprite_height=16, columns=10, count=100)
